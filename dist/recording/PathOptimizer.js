...
class PathOptimizer {
    ...
    optimize(path) {
        ...
        logger_1.logger.info('Path optimization complete', {
    ...
    deduplicateAssertions(assertions) {
    ...
    isMoreSpecific(a, b) {
        ...
        if (a.operator === 'equals' && b.operator === 'contains')
            return true;
        if (a.operator === 'contains' && b.operator === 'equals')
            return false;
