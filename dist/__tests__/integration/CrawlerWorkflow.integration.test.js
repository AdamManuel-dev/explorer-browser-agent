...
const ResilientCrawler_1 = require("../../crawler/ResilientCrawler");
...
describe('Crawler Workflow Integration Tests', () => {
    ...
    function generateTestData(selector) {
        const dataMap = {
            'first-name': 'John',
            'last-name': 'Doe',
    ...
    beforeAll(async () => {
        ...
        const tempDir = (0, path_1.join)((0, os_1.tmpdir)(), 'crawler-workflow-test');
        testOutputDir = (0, path_1.join)(tempDir, 'output');
    ...
    afterAll(async () => {
        ...
        try {
            (0, fs_1.rmSync)((0, path_1.join)((0, os_1.tmpdir)(), 'crawler-workflow-test'), { recursive: true, force: true });
        }
        catch (error) {
    ...
    describe('Complete Crawling Workflows', () => {
        it('should crawl a complex e-commerce site with BreadthFirstCrawler', async () => {
            const crawler = new BreadthFirstCrawler_1.BreadthFirstCrawler(browser);
        ...
        it('should handle resilient crawling with failures', async () => {
            const resilientCrawler = new ResilientCrawler_1.ResilientCrawler(browser, {
                circuitBreaker: {
                    failureThreshold: 3,
        ...
        it('should handle complex form interactions and data generation', async () => {
            ...
            try {
                ...
                const formElements = elements.filter((el) => el.type === 'input' || el.type === 'form' || el.type === 'button');
    ...
    describe('Performance and Load Testing', () => {
        it('should handle concurrent crawling sessions', async () => {
            ...
            try {
                ...
                const crawlers = [1, 2, 3].map(() => new BreadthFirstCrawler_1.BreadthFirstCrawler(browser));
...
//# sourceMappingURL=CrawlerWorkflow.integration.test.js.map