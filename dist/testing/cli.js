...
program
    ...
    try {
        ...
        const runner = new SelfTestRunner_1.SelfTestRunner(config);
        ...
        console.log('');
        const reportFile = (0, path_1.join)(options.output, `self-test-report-${Date.now()}.json`);
...
program
    ...
    const checks = [
        ...
        },
        {
            ...
            check: () => {
                try {
                    const testFile = (0, path_1.join)(process.cwd(), '.test-write-permission');
