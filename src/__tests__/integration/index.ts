...
export function createTestServer(port: number, routes: any) {
...
export async function waitForNavigation(page: any, expectedUrl?: string, timeout = 10000) {
...
export class TestMetricsCollector {
  ...
  getSummary(): Record<string, { avg: number; max: number; min: number; total: number; count: number }> {
